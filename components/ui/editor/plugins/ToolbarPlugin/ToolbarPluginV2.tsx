...
import {
    ...
    $patchStyleText,
    $selectAll,
    $setBlocksType as $setBlocksType_experimental,
...
function BlockFormatDropDown({
    ...
    return (
        ...
        >
            <DropDownItem
                className={
                    'item ' + dropDownActiveClass(blockType === 'paragraph')
                }
            ...
            <DropDownItem
                className={
                    'item ' + dropDownActiveClass(blockType === 'bullet')
                }
            ...
            <DropDownItem
                className={
                    'item ' + dropDownActiveClass(blockType === 'number')
                }
...
export function ToolbarPluginV2({ isCompact = false }: Props) {
                    ...
                    {!isMobile && (
                        ...
                        >
                            ...
                            <DropDownItem
                                ...
                                className={
                                    'item ' + dropDownActiveClass(isSubscript)
                                }
                                title="Subscript"
                            ...
                            <DropDownItem
                                ...
                                className={
                                    'item ' + dropDownActiveClass(isSuperscript)
                                }
                                title="Superscript"
                            ...
                            >
                                ...
                                <DropDownItem
                                    onClick={() => {
                                        showModal(
                                            t(
                                                'commons.editor.image.modal.title'
                                            ),
                                            (onClose) => (
                                                <InsertImageDialog
