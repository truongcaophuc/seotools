...
function TextFormatFloatingToolbar({
    ...
    const searchPexelsPhotos = () => {
        editor.dispatchCommand(INSERT_INLINE_PEXELS, undefined);
    };
            ...
            {editor.isEditable() && (
                <>
                    ...
                    <button
                        ...
                        aria-label="Insert Image pexels"
                    >
                        <i className="format pexels" />
                    </button>
...
export default function FloatingRewritePlugin({
